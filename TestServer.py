...
class TcpServer:
    ...
    def get_connect(self):
        while True:
            ...
            client.send((config.SERVER_CONNECT_SUCCESS_MSG + "," + config.SERVER_CONNECT_SUCCESS_NEED_NAME_INPUT + ":").encode())
    ...
    def deal_msg(self, client, addr):
        ...
        while True:
            ...
            if coding in config.CODE_MSG_NAME:
                ...
                client.send(config.SERVER_CONNECT_SUCCESS_NEED_CHANNEL_INPUT.encode())
